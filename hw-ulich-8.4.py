...
class DisciplineTeacher(Teacher):
    ...
    def change_discipline(self, new_discipline):
        self._discipline = new_discipline
        print(f"Дисциплина преподавателя {self._name} изменена на {new_discipline}")
...
teacher = DisciplineTeacher("Иван Петров", "БПГУ", 10, "Химия", "Директор")
teacher.change_discipline("Физика")